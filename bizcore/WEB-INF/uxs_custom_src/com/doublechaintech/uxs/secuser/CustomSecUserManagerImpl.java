...
import com.doublechaintech.uxs.UxsUserContextImpl;
import com.doublechaintech.uxs.LoginForm;
import com.doublechaintech.uxs.BaseEntity;
import com.doublechaintech.uxs.CommonError;
import com.doublechaintech.uxs.DAOGroup;
import com.doublechaintech.uxs.ManagerGroup;

import com.doublechaintech.uxs.UserContextImpl;
import com.doublechaintech.uxs.userapp.UserApp;
import com.doublechaintech.uxs.UxsUserContext;
import com.doublechaintech.uxs.userapp.*;
import com.doublechaintech.uxs.listaccess.*;
import com.doublechaintech.uxs.objectaccess.*;
import com.doublechaintech.uxs.UxsChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(UxsUserContext userContext){
    ...
    public Object resetPassword(UxsUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(UxsUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(UxsUserContext userContext,
    ...
    public SecUser manage(UxsUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(UxsUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(UxsUserContext userContext) {
    ...
    protected Object gotoApp(UxsUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(UxsUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(UxsUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(UxsUserContext userContex, int length){
    ...
    protected String getBeanName(UxsUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(UxsUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(UxsUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(UxsUserContext userContext, UserApp app){
    ...
    public Object home(UxsUserContext userContext) {
    ...
    public Object loginWithEmail(UxsUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(UxsUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(UxsUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(UxsUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(UxsUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(UxsUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(UxsUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(UxsUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(UxsUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        UxsUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected UxsChecker checker;
    public UxsChecker getChecker(){
        return checker;
    }
    
    public void setChecker(UxsChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((UxsChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected UxsUserContextImpl createNewConext(String path) {

        return new UxsUserContextImpl();
    ...
    public Object checkOtherLogin(UxsUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(UxsUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(UxsUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(UxsUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(UxsUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(UxsUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(UxsUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
