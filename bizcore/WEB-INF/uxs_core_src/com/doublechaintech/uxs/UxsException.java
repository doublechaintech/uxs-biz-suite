...
@JsonSerialize(using = UxsExceptionJsonSerializer.class)
public class UxsException extends Exception implements MessageContainer {
    ...
    public UxsException(String message) {
        super(message);
    }
    public UxsException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public UxsException(List<Message> messageList) {
        super();
    ...
    public UxsException(String message, Throwable cause) {
        super(message, cause);
    }


    public UxsException(Throwable cause) {
        super(cause);
    }
