...
import com.doublechaintech.uxs.secuser.SecUserCustomManagerImpl;
...
public class UxsUserContextImpl extends UserContextImpl implements UxsUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.uxs.UxsResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.uxs.UxsCustomResources";
    ...
    /*
    public static SecUser getSecUser(UxsUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(UxsUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(UxsUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(UxsUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
