...
@JsonSerialize(using = EditorPickProductSerializer.class)
public class EditorPickProduct extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="EditorPickProduct";
	...
	public 	EditorPickProduct(String name, LevelNCategory parentCategory, Brand brand, String productCoverImage, String origin, Catalog catalog, Profile profile, String remark, DateTime lastUpdateTime, Platform platform)
	{
		setName(name);
	...
	public EditorPickProduct updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateName(String name){
		this.mName = trimString(name);;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateParentCategory(LevelNCategory parentCategory){
		this.mParentCategory = parentCategory;;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateBrand(Brand brand){
		this.mBrand = brand;;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateProductCoverImage(String productCoverImage){
		this.mProductCoverImage = trimString(encodeUrl(productCoverImage));;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateOrigin(String origin){
		this.mOrigin = trimString(origin);;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateCatalog(Catalog catalog){
		this.mCatalog = catalog;;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateProfile(Profile profile){
		this.mProfile = profile;;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateRemark(String remark){
		this.mRemark = trimString(remark);;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateLastUpdateTime(DateTime lastUpdateTime){
		this.mLastUpdateTime = lastUpdateTime;;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updatePlatform(Platform platform){
		this.mPlatform = platform;;
		this.changed = true;
		return this;
	}
	...
	public EditorPickProduct updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof EditorPickProduct){
		
		
			EditorPickProduct dest =(EditorPickProduct)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("EditorPickProduct{");
