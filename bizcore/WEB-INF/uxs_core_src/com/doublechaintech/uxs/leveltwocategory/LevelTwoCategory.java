...
public class LevelTwoCategory extends BaseEntity implements  java.io.Serializable{
	...
	public  void mergeLevelNCategoryList(SmartList<LevelNCategory> levelNCategoryList){
		if(levelNCategoryList==null){
			return;
		}
		if(levelNCategoryList.isEmpty()){
			return;
		}
		addLevelNCategoryList( levelNCategoryList );
	...
	public BaseEntity mergeDataTo(BaseEntity baseDest){
		...
		if(baseDest instanceof LevelTwoCategory){
			...
			dest.mergeLevelNCategoryList(getLevelNCategoryList());
