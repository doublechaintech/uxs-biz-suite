...
@JsonSerialize(using = TopRatedProductSerializer.class)
public class TopRatedProduct extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="TopRatedProduct";
	...
	public 	TopRatedProduct(String name, LevelNCategory parentCategory, Brand brand, String productCoverImage, String origin, Catalog catalog, String remark, DateTime lastUpdateTime, Profile profile, Platform platform)
	{
		setName(name);
	...
	public TopRatedProduct updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateName(String name){
		this.mName = trimString(name);;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateParentCategory(LevelNCategory parentCategory){
		this.mParentCategory = parentCategory;;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateBrand(Brand brand){
		this.mBrand = brand;;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateProductCoverImage(String productCoverImage){
		this.mProductCoverImage = trimString(encodeUrl(productCoverImage));;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateOrigin(String origin){
		this.mOrigin = trimString(origin);;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateCatalog(Catalog catalog){
		this.mCatalog = catalog;;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateRemark(String remark){
		this.mRemark = trimString(remark);;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateLastUpdateTime(DateTime lastUpdateTime){
		this.mLastUpdateTime = lastUpdateTime;;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateProfile(Profile profile){
		this.mProfile = profile;;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updatePlatform(Platform platform){
		this.mPlatform = platform;;
		this.changed = true;
		return this;
	}
	...
	public TopRatedProduct updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public String toString(){
		...
		stringBuilder.append("TopRatedProduct{");
