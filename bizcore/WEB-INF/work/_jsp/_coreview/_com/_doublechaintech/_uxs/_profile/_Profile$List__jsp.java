...
public class _Profile$List__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty profileList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['profile']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty profileList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'profileList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${profileListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['profile.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'name'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['profile.name']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'platform'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['profile.platform']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${profileList}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.version}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.id}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.name}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'$'}");
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.platform}");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.id}");
    _caucho_expr_36 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.displayName}");
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.platform}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@delete']}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@copy']}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/profile/Profile$List.jsp"), 5885222163072060214L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string0 = "\n\n\n\n\n\n\n".toCharArray();
    _jsp_string29 = "\n	<th>".toCharArray();
    _jsp_string40 = "Manager/updateProfile/".toCharArray();
    _jsp_string45 = "/\"\n			data-link-template=\"./platformManager/view/".toCharArray();
    _jsp_string14 = "\">".toCharArray();
    _jsp_string52 = "\n\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string26 = "</a>\n	</li>\n".toCharArray();
    _jsp_string57 = "/' class='copy-action btn btn-success btn-xs'><i class=\"fa fa-files-o fa-lg\"></i> ".toCharArray();
    _jsp_string49 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    ...
    _jsp_string34 = "' id=\"profile-".toCharArray();
    _jsp_string30 = "</th>\n".toCharArray();
    _jsp_string8 = "\n    \n 	   \n    <div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		<i class='fa fa-table'></i> ".toCharArray();
    _jsp_string43 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./profileManager/requestCandidatePlatform/".toCharArray();
    _jsp_string51 = "\n			<button class=\"btn btn-link candidate-action\">...</button>\n		</span>\n		<div class=\"candidate_span\" style=\"display:none;\">\n			<input type=\"text\" data-provide=\"typeahead\" class=\"input-sm form-control candidate-filter-input\" autocomplete=\"off\" />\n		</div>\n	</td>\n".toCharArray();
    _jsp_string2 = "\n	<div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		 ".toCharArray();
    _jsp_string53 = "Manager/removeProfile/".toCharArray();
    _jsp_string17 = "\n	</div><!--end of div class=\"btn-group\" -->\n	\n		 \n		 \n		 \n		 </div>\n </div>\n    \n    \n<div class=\"table-responsive\">\n\n\n".toCharArray();
    _jsp_string28 = "'>\n		<thead><tr>\n		".toCharArray();
    _jsp_string58 = " </a>\n\n				</td>\n				</tr>\n			".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./profileManager/view/".toCharArray();
    _jsp_string16 = "\n	".toCharArray();
    ...
    _jsp_string55 = "</a>\n				<a href='#".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='profileListCurrentPage=".toCharArray();
    ...
    _jsp_string32 = "</th>\n		</tr></thead>\n		<tbody>\n			\n			".toCharArray();
    _jsp_string54 = "/' class='delete-action btn btn-danger btn-xs'><i class=\"fa fa-trash-o fa-lg\"></i> ".toCharArray();
    _jsp_string31 = "\n<th>".toCharArray();
    _jsp_string44 = "/\"\n			data-switch-method=\"./profileManager/transferToAnotherPlatform/".toCharArray();
    _jsp_string23 = "CurrentPage=".toCharArray();
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string4 = "Manager/addProfile/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string56 = "Manager/copyProfileFrom/".toCharArray();
    _jsp_string50 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
  }
}
