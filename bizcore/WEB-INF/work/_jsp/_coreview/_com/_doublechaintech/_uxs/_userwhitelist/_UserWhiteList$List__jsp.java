...
package _jsp._coreview._com._doublechaintech._uxs._userwhitelist;
...
public class _UserWhiteList$List__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty userWhiteListList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_white_list']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userWhiteListList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'userWhiteListList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userWhiteListListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_white_list.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'userIdentity'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_white_list.user_identity']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'userSpecialFunctions'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_white_list.user_special_functions']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'domain'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_white_list.domain']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userWhiteListList}");
    ...
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.userIdentity}");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.userSpecialFunctions}");
    _caucho_expr_36 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'$'}");
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.domain}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.domain.id}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.domain.displayName}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.domain}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/userwhitelist/UserWhiteList$List.jsp"), 684877566452431592L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string28 = "'>\n		<thead><tr>\n		".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='userWhiteListListCurrentPage=".toCharArray();
    _jsp_string59 = " </a>\n\n				</td>\n				</tr>\n			".toCharArray();
    _jsp_string40 = "Manager/updateUserWhiteList/".toCharArray();
    _jsp_string16 = "\n	".toCharArray();
    _jsp_string34 = "' id=\"userWhiteList-".toCharArray();
    _jsp_string9 = ")\n		<a href=\"./".toCharArray();
    _jsp_string49 = "</a>\n			".toCharArray();
    _jsp_string3 = "! \n		 <a href=\"./".toCharArray();
    _jsp_string57 = "Manager/copyUserWhiteListFrom/".toCharArray();
    _jsp_string5 = "/\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\"></i></a>\n		 \n		 \n		 \n		 </div>\n	</div>\n\n".toCharArray();
    _jsp_string38 = "	<td contenteditable='true' class='edit-value'  propertyToChange='userIdentity' storedCellValue='".toCharArray();
    _jsp_string41 = "/'>".toCharArray();
    _jsp_string56 = "</a>\n				<a href='#".toCharArray();
    _jsp_string10 = "/\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\"></i></a>\n		 \n		 		 	<div class=\"btn-group\" role=\"group\" aria-label=\"Button group with nested dropdown\">		\n	".toCharArray();
    _jsp_string44 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./userWhiteListManager/requestCandidateDomain/".toCharArray();
    ...
    _jsp_string31 = "\n<th>".toCharArray();
    _jsp_string45 = "/\"\n			data-switch-method=\"./userWhiteListManager/transferToAnotherDomain/".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./userWhiteListManager/view/".toCharArray();
    _jsp_string23 = "CurrentPage=".toCharArray();
    _jsp_string54 = "Manager/removeUserWhiteList/".toCharArray();
    _jsp_string43 = "	<td contenteditable='true' class='edit-value'  propertyToChange='userSpecialFunctions' storedCellValue='".toCharArray();
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string4 = "Manager/addUserWhiteList/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string51 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
