...
package _jsp._coreview._com._doublechaintech._uxs._userdomain;
...
public class _UserDomain__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      pageContext.requestSetOrRemove("ownerBeanName", "userDomain");
      out.write('\n');
      pageContext.requestSetOrRemove("ownerClassName", "UserDomain");
      ...
      pageContext.requestSetOrRemove("userDomain", _caucho_expr_9.evalObject(_jsp_env));
      out.write('\n');
      _jsp__include__tag_1 = new _jsp._tags._include__tag();
      _jsp__include__tag_1.setJspContext(pageContext);
      _jsp__include__tag_1.setPage("com/doublechaintech/uxs/userdomain/UserDomain$Summary.jsp");
      _jsp__include__tag_1.doTag();
      out.write(_jsp_string14, 0, _jsp_string14.length);
      if (_caucho_expr_10.evalBoolean(_jsp_env)) {
        out.write(_jsp_string15, 0, _jsp_string15.length);
        pageContext.requestSetOrRemove("userWhiteListList", _caucho_expr_11.evalObject(_jsp_env));
        out.write(_jsp_string15, 0, _jsp_string15.length);
        pageContext.requestSetOrRemove("userWhiteListListName", "userWhiteListList");
        out.write(_jsp_string16, 0, _jsp_string16.length);
        _jsp__include__tag_2 = new _jsp._tags._include__tag();
        _jsp__include__tag_2.setJspContext(pageContext);
        _jsp__include__tag_2.setReferName("domain");
        _jsp__include__tag_2.setPage("com/doublechaintech/uxs/userwhitelist/UserWhiteList$List.jsp");
      ...
      if (_caucho_expr_12.evalBoolean(_jsp_env)) {
        out.write(_jsp_string15, 0, _jsp_string15.length);
        pageContext.requestSetOrRemove("secUserList", _caucho_expr_13.evalObject(_jsp_env));
        out.write(_jsp_string15, 0, _jsp_string15.length);
        pageContext.requestSetOrRemove("secUserListName", "secUserList");
        out.write(_jsp_string19, 0, _jsp_string19.length);
        _jsp__include__tag_2 = new _jsp._tags._include__tag();
        _jsp__include__tag_2.setJspContext(pageContext);
        _jsp__include__tag_2.setReferName("domain");
        _jsp__include__tag_2.setPage("com/doublechaintech/uxs/secuser/SecUser$List.jsp");
        _jsp__include__tag_2.doTag();
        out.write(_jsp_string17, 0, _jsp_string17.length);
      }
    ...
    throws ServletException
  {
    ...
    _caucho_expr_7 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_white_list']}");
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['sec_user']}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"userWhiteListList\"] or ignoreListAccessControl}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.userWhiteListList}");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"secUserList\"] or ignoreListAccessControl}");
    _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.secUserList}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/userdomain/UserDomain.jsp"), -3913169096544409026L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string15 = "\n		".toCharArray();
    _jsp_string11 = "\n			<li><a data-toggle=\"tab\" href=\"#userWhiteListList\" class=\"disabled\"> ".toCharArray();
    ...
    _jsp_string17 = "\n		</div>\n	".toCharArray();
    _jsp_string12 = "</a></li>\n			<li><a data-toggle=\"tab\" href=\"#secUserList\" class=\"disabled\"> ".toCharArray();
