...
public class _Profile__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      pageContext.requestSetOrRemove("profile", _caucho_expr_11.evalObject(_jsp_env));
      out.write('\n');
      ...
      pageContext.requestSetOrRemove("platform", _caucho_expr_12.evalObject(_jsp_env));
      out.write('\n');
      _jsp__include__tag_1 = new _jsp._tags._include__tag();
      _jsp__include__tag_1.setJspContext(pageContext);
      ...
      if (_caucho_expr_13.evalBoolean(_jsp_env)) {
        ...
        pageContext.requestSetOrRemove("targetList", _caucho_expr_14.evalObject(_jsp_env));
        out.write(_jsp_string18, 0, _jsp_string18.length);
      ...
      if (_caucho_expr_15.evalBoolean(_jsp_env)) {
        out.write(_jsp_string18, 0, _jsp_string18.length);
        pageContext.requestSetOrRemove("ratingList", _caucho_expr_16.evalObject(_jsp_env));
        out.write(_jsp_string18, 0, _jsp_string18.length);
      ...
      if (_caucho_expr_17.evalBoolean(_jsp_env)) {
        out.write(_jsp_string18, 0, _jsp_string18.length);
        pageContext.requestSetOrRemove("reviewList", _caucho_expr_18.evalObject(_jsp_env));
        out.write(_jsp_string18, 0, _jsp_string18.length);
      ...
      if (_caucho_expr_19.evalBoolean(_jsp_env)) {
        out.write(_jsp_string18, 0, _jsp_string18.length);
        pageContext.requestSetOrRemove("blogList", _caucho_expr_20.evalObject(_jsp_env));
        out.write(_jsp_string18, 0, _jsp_string18.length);
    ...
    throws ServletException
  {
    ...
    _caucho_expr_7 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target']}");
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating']}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review']}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['blog']}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result}");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result.platform}");
    _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"targetList\"] or ignoreListAccessControl}");
    _caucho_expr_14 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.targetList}");
    _caucho_expr_15 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"ratingList\"] or ignoreListAccessControl}");
    _caucho_expr_16 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.ratingList}");
    _caucho_expr_17 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"reviewList\"] or ignoreListAccessControl}");
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.reviewList}");
    _caucho_expr_19 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"blogList\"] or ignoreListAccessControl}");
    _caucho_expr_20 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.blogList}");
    _caucho_expr_21 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@home_page']}");
    _caucho_expr_22 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@message']}");
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@log_out']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@qr_code']}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@qr_scan_to_continue']}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/profile/Profile.jsp"), 1523411257774920868L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
