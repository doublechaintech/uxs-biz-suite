...
package _jsp._coreview._com._doublechaintech._uxs._product;
...
public class _Product$List__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty productList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['product']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty productList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'productList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${productListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['product.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'name'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['product.name']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'platform'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['product.platform']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'avarageScore'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['product.avarage_score']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${productList}");
    ...
    _caucho_expr_36 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.platform}");
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.id}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.displayName}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.platform}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.avarageScore}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/product/Product$List.jsp"), -8789683162204848258L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string34 = "' id=\"product-".toCharArray();
    _jsp_string14 = "\">".toCharArray();
    _jsp_string26 = "</a>\n	</li>\n".toCharArray();
    _jsp_string57 = "Manager/copyProductFrom/".toCharArray();
    _jsp_string58 = "/' class='copy-action btn btn-success btn-xs'><i class=\"fa fa-files-o fa-lg\"></i> ".toCharArray();
    _jsp_string43 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./productManager/requestCandidatePlatform/".toCharArray();
    _jsp_string54 = "Manager/removeProduct/".toCharArray();
    _jsp_string49 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    ...
    _jsp_string11 = "\n		".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='productListCurrentPage=".toCharArray();
    ...
    _jsp_string52 = "	<td contenteditable='true' class='edit-value'  propertyToChange='avarageScore' storedCellValue='".toCharArray();
    _jsp_string28 = "'>\n		<thead><tr>\n		".toCharArray();
    _jsp_string59 = " </a>\n\n				</td>\n				</tr>\n			".toCharArray();
    _jsp_string53 = "\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string16 = "\n	".toCharArray();
    ...
    _jsp_string48 = "</a>\n			".toCharArray();
    _jsp_string3 = "! \n		 <a href=\"./".toCharArray();
    _jsp_string4 = "Manager/addProduct/".toCharArray();
    _jsp_string5 = "/\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\"></i></a>\n		 \n		 \n		 \n		 </div>\n	</div>\n\n".toCharArray();
    _jsp_string44 = "/\"\n			data-switch-method=\"./productManager/transferToAnotherPlatform/".toCharArray();
    ...
    _jsp_string31 = "\n<th>".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./productManager/view/".toCharArray();
    _jsp_string23 = "CurrentPage=".toCharArray();
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string40 = "Manager/updateProduct/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string50 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
