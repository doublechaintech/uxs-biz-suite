...
package _jsp._coreview._com._doublechaintech._uxs._target;
...
public class _Target$List__jsp extends com.caucho.jsp.JavaPage
{
 	...
 	//the reason using scriptlet here is the el express is currently not able resolv common property from a subclass of list
        ...
        while (_jsp_iter_7.hasNext()) {
          ...
          if (_caucho_expr_32.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatDateTag_1.setValue(_caucho_expr_49.evalObject(_jsp_env));
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty targetList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty targetList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'targetList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${targetListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'name'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target.name']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'profile'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target.profile']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'banner'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target.banner']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'location'}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target.location']}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'lastUpdate'}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['target.last_update']}");
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${targetList}");
    ...
    _caucho_expr_44 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.banner}");
    _caucho_expr_45 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.banner.id}");
    _caucho_expr_46 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.banner.displayName}");
    _caucho_expr_47 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.banner}");
    _caucho_expr_48 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.location}");
    _caucho_expr_49 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.lastUpdate}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/target/Target$List.jsp"), -3825151525100266927L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string43 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./targetManager/requestCandidateProfile/".toCharArray();
    _jsp_string46 = "{ID}/\">\n		<span class=\"display_span\">\n			".toCharArray();
    _jsp_string44 = "/\"\n			data-switch-method=\"./targetManager/transferToAnotherProfile/".toCharArray();
    _jsp_string22 = "Manager/load".toCharArray();
    _jsp_string65 = "\n		\n		</tbody>\n	</table>	\n	\n\n</div>".toCharArray();
    _jsp_string13 = " btn-sm\" href=\"".toCharArray();
    _jsp_string12 = "\n		<a class=\"btn btn-".toCharArray();
    _jsp_string52 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./targetManager/requestCandidateBanner/".toCharArray();
    _jsp_string25 = "/' \n			class='page-link page-action '>".toCharArray();
    _jsp_string0 = "\n\n\n\n\n\n\n".toCharArray();
    _jsp_string29 = "\n	<th>".toCharArray();
    _jsp_string14 = "\">".toCharArray();
    _jsp_string34 = "' id=\"target-".toCharArray();
    _jsp_string26 = "</a>\n	</li>\n".toCharArray();
    _jsp_string63 = "/' class='copy-action btn btn-success btn-xs'><i class=\"fa fa-files-o fa-lg\"></i> ".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='targetListCurrentPage=".toCharArray();
    _jsp_string59 = "Manager/removeTarget/".toCharArray();
    _jsp_string49 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string4 = "Manager/addTarget/".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    _jsp_string20 = "\n\n\n	<li class=\"page-item ".toCharArray();
    _jsp_string53 = "/\"\n			data-switch-method=\"./targetManager/transferToAnotherBanner/".toCharArray();
    _jsp_string18 = "	\n\n\n\n<nav aria-label=\"Page navigation example\">\n  <ul class=\"pagination\">\n".toCharArray();
    _jsp_string11 = "\n		".toCharArray();
    _jsp_string40 = "Manager/updateTarget/".toCharArray();
    _jsp_string36 = "/\"> ".toCharArray();
    _jsp_string6 = "\n\n\n\n\n	\n\n ".toCharArray();
    _jsp_string1 = "\n\n\n".toCharArray();
    _jsp_string56 = "	<td contenteditable='true' class='edit-value'  propertyToChange='location' storedCellValue='".toCharArray();
    ...
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./targetManager/view/".toCharArray();
    _jsp_string9 = ")\n		<a href=\"./".toCharArray();
    _jsp_string48 = "</a>\n			".toCharArray();
    _jsp_string3 = "! \n		 <a href=\"./".toCharArray();
    ...
    _jsp_string62 = "Manager/copyTargetFrom/".toCharArray();
    ...
    _jsp_string55 = "\n			<a href='./bannerManager/view/".toCharArray();
    _jsp_string47 = "\n			<a href='./profileManager/view/".toCharArray();
    _jsp_string23 = "CurrentPage=".toCharArray();
    _jsp_string54 = "/\"\n			data-link-template=\"./bannerManager/view/".toCharArray();
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string57 = "	<td contenteditable='true' class='edit-value'  propertyToChange='lastUpdate' storedCellValue='".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string50 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
