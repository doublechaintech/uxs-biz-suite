...
package _jsp._coreview._com._doublechaintech._uxs._review;
...
public class _Review$List__jsp extends com.caucho.jsp.JavaPage
{
 	...
 	//the reason using scriptlet here is the el express is currently not able resolv common property from a subclass of list
        ...
        while (_jsp_iter_7.hasNext()) {
          ...
          if (_caucho_expr_32.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatDateTag_1.setValue(_caucho_expr_50.evalObject(_jsp_env));
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty reviewList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty reviewList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'reviewList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${reviewListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'title'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review.title']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'content'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review.content']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'user'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review.user']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'product'}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review.product']}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'updateTime'}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['review.update_time']}");
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${reviewList}");
    ...
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.title}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.content}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${fn:substring(item.content,0,10)}");
    _caucho_expr_41 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'$'}");
    _caucho_expr_42 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.user}");
    _caucho_expr_43 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.user.id}");
    _caucho_expr_44 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.user.displayName}");
    _caucho_expr_45 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.user}");
    _caucho_expr_46 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.product}");
    _caucho_expr_47 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.product.id}");
    _caucho_expr_48 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.product.displayName}");
    _caucho_expr_49 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.product}");
    _caucho_expr_50 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.updateTime}");
    _caucho_expr_51 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@delete']}");
    _caucho_expr_52 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@copy']}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/review/Review$List.jsp"), 6843416447732592191L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string65 = "Manager/copyReviewFrom/".toCharArray();
    _jsp_string58 = "/\"\n			data-link-template=\"./productManager/view/".toCharArray();
    _jsp_string50 = "{ID}/\">\n		<span class=\"display_span\">\n			".toCharArray();
    _jsp_string22 = "Manager/load".toCharArray();
    _jsp_string68 = "\n		\n		</tbody>\n	</table>	\n	\n\n</div>".toCharArray();
    _jsp_string59 = "\n			<a href='./productManager/view/".toCharArray();
    _jsp_string60 = "	<td contenteditable='true' class='edit-value'  propertyToChange='updateTime' storedCellValue='".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='reviewListCurrentPage=".toCharArray();
    _jsp_string13 = " btn-sm\" href=\"".toCharArray();
    _jsp_string12 = "\n		<a class=\"btn btn-".toCharArray();
    _jsp_string25 = "/' \n			class='page-link page-action '>".toCharArray();
    _jsp_string0 = "\n\n\n\n\n\n\n".toCharArray();
    _jsp_string44 = "/'><a title='".toCharArray();
    _jsp_string29 = "\n	<th>".toCharArray();
    ...
    _jsp_string11 = "\n		".toCharArray();
    _jsp_string48 = "/\"\n			data-switch-method=\"./reviewManager/transferToAnotherUser/".toCharArray();
    _jsp_string57 = "/\"\n			data-switch-method=\"./reviewManager/transferToAnotherProduct/".toCharArray();
    _jsp_string36 = "/\"> ".toCharArray();
    _jsp_string6 = "\n\n\n\n\n	\n\n ".toCharArray();
    _jsp_string1 = "\n\n\n".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./reviewManager/view/".toCharArray();
    ...
    _jsp_string61 = "\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string16 = "\n	".toCharArray();
    _jsp_string56 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./reviewManager/requestCandidateProduct/".toCharArray();
    _jsp_string9 = ")\n		<a href=\"./".toCharArray();
    _jsp_string52 = "</a>\n			".toCharArray();
    _jsp_string3 = "! \n		 <a href=\"./".toCharArray();
    _jsp_string47 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./reviewManager/requestCandidateUser/".toCharArray();
    ...
    _jsp_string34 = "' id=\"review-".toCharArray();
    ...
    _jsp_string62 = "Manager/removeReview/".toCharArray();
    _jsp_string51 = "\n			<a href='./profileManager/view/".toCharArray();
    _jsp_string23 = "CurrentPage=".toCharArray();
    _jsp_string43 = "	<td contenteditable='true' class='edit-value'  propertyToChange='content' storedCellValue='".toCharArray();
    _jsp_string4 = "Manager/addReview/".toCharArray();
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string40 = "Manager/updateReview/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string38 = "	<td contenteditable='true' class='edit-value'  propertyToChange='title' storedCellValue='".toCharArray();
    _jsp_string54 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
  }
}
