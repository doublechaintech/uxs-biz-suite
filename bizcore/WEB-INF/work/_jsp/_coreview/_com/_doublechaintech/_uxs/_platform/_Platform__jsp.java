...
public class _Platform__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      _jsp__include__tag_1.setPage("com/doublechaintech/uxs/platform/Platform$Summary.jsp");
      _jsp__include__tag_1.doTag();
      out.write(_jsp_string15, 0, _jsp_string15.length);
      if (_caucho_expr_11.evalBoolean(_jsp_env)) {
        out.write(_jsp_string16, 0, _jsp_string16.length);
        pageContext.requestSetOrRemove("productList", _caucho_expr_12.evalObject(_jsp_env));
        out.write(_jsp_string16, 0, _jsp_string16.length);
        pageContext.requestSetOrRemove("productListName", "productList");
        ...
        _jsp__include__tag_2.setPage("com/doublechaintech/uxs/product/Product$List.jsp");
      ...
      if (_caucho_expr_13.evalBoolean(_jsp_env)) {
        out.write(_jsp_string16, 0, _jsp_string16.length);
        pageContext.requestSetOrRemove("bannerList", _caucho_expr_14.evalObject(_jsp_env));
        out.write(_jsp_string16, 0, _jsp_string16.length);
        pageContext.requestSetOrRemove("bannerListName", "bannerList");
        out.write(_jsp_string20, 0, _jsp_string20.length);
        _jsp__include__tag_2 = new _jsp._tags._include__tag();
        _jsp__include__tag_2.setJspContext(pageContext);
        _jsp__include__tag_2.setReferName("platform");
        _jsp__include__tag_2.setPage("com/doublechaintech/uxs/banner/Banner$List.jsp");
        _jsp__include__tag_2.doTag();
        out.write(_jsp_string18, 0, _jsp_string18.length);
      }
      out.write(_jsp_string19, 0, _jsp_string19.length);
      if (_caucho_expr_15.evalBoolean(_jsp_env)) {
        out.write(_jsp_string16, 0, _jsp_string16.length);
        pageContext.requestSetOrRemove("profileList", _caucho_expr_16.evalObject(_jsp_env));
        out.write(_jsp_string16, 0, _jsp_string16.length);
        pageContext.requestSetOrRemove("profileListName", "profileList");
        out.write(_jsp_string21, 0, _jsp_string21.length);
        _jsp__include__tag_2 = new _jsp._tags._include__tag();
        _jsp__include__tag_2.setJspContext(pageContext);
        _jsp__include__tag_2.setReferName("platform");
        _jsp__include__tag_2.setPage("com/doublechaintech/uxs/profile/Profile$List.jsp");
        _jsp__include__tag_2.doTag();
        out.write(_jsp_string18, 0, _jsp_string18.length);
      }
    ...
    throws ServletException
  {
    ...
    _caucho_expr_7 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['product']}");
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner']}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['profile']}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"productList\"] or ignoreListAccessControl}");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.productList}");
    _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"bannerList\"] or ignoreListAccessControl}");
    _caucho_expr_14 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.bannerList}");
    _caucho_expr_15 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"profileList\"] or ignoreListAccessControl}");
    _caucho_expr_16 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.profileList}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/platform/Platform.jsp"), -8607530639290113388L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string11 = "\n			<li><a data-toggle=\"tab\" href=\"#productList\" class=\"disabled\"> ".toCharArray();
    ...
    _jsp_string16 = "\n		".toCharArray();
    _jsp_string13 = "</a></li>\n			<li><a data-toggle=\"tab\" href=\"#profileList\" class=\"disabled\"> ".toCharArray();
    ...
    _jsp_string8 = "\n    	</ul>\n    ".toCharArray();
    _jsp_string12 = "</a></li>\n			<li><a data-toggle=\"tab\" href=\"#bannerList\" class=\"disabled\"> ".toCharArray();
    _jsp_string0 = "\n\n\n\n\n\n\n\n".toCharArray();
    _jsp_string7 = "\n</div>\n    	".toCharArray();
    _jsp_string10 = "</a></li>\n	 \n	".toCharArray();
    _jsp_string19 = "\n	".toCharArray();
