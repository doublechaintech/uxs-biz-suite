...
package _jsp._coreview._com._doublechaintech._uxs._banner;
...
public class _Banner$List__jsp extends com.caucho.jsp.JavaPage
{
 	...
 	//the reason using scriptlet here is the el express is currently not able resolv common property from a subclass of list
        ...
        while (_jsp_iter_7.hasNext()) {
          ...
          if (_caucho_expr_28.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatDateTag_1.setValue(_caucho_expr_38.evalObject(_jsp_env));
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty bannerList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty bannerList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'bannerList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${bannerListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'name'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner.name']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'imagePath'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner.image_path']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'lastUpdate'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner.last_update']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'platform'}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['banner.platform']}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${bannerList}");
    ...
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.imagePath}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.lastUpdate}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'$'}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.platform}");
    _caucho_expr_41 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.id}");
    _caucho_expr_42 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.displayName}");
    _caucho_expr_43 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.platform}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/banner/Banner$List.jsp"), -7647947651192813744L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='bannerListCurrentPage=".toCharArray();
    _jsp_string48 = "{ID}/\">\n		<span class=\"display_span\">\n			".toCharArray();
    _jsp_string34 = "' id=\"banner-".toCharArray();
    _jsp_string22 = "Manager/load".toCharArray();
    _jsp_string61 = "\n		\n		</tbody>\n	</table>	\n	\n\n</div>".toCharArray();
    _jsp_string43 = "	<td contenteditable='true' class='edit-value'  propertyToChange='imagePath' storedCellValue='".toCharArray();
    ...
    _jsp_string55 = "Manager/removeBanner/".toCharArray();
    _jsp_string4 = "Manager/addBanner/".toCharArray();
    _jsp_string54 = "\n\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string26 = "</a>\n	</li>\n".toCharArray();
    _jsp_string59 = "/' class='copy-action btn btn-success btn-xs'><i class=\"fa fa-files-o fa-lg\"></i> ".toCharArray();
    _jsp_string40 = "Manager/updateBanner/".toCharArray();
    _jsp_string51 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    ...
    _jsp_string6 = "\n\n\n\n\n	\n\n ".toCharArray();
    _jsp_string58 = "Manager/copyBannerFrom/".toCharArray();
    _jsp_string1 = "\n\n\n".toCharArray();
    ...
    _jsp_string45 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./bannerManager/requestCandidatePlatform/".toCharArray();
    ...
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./bannerManager/view/".toCharArray();
    ...
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string44 = "	<td contenteditable='true' class='edit-value'  propertyToChange='lastUpdate' storedCellValue='".toCharArray();
    _jsp_string46 = "/\"\n			data-switch-method=\"./bannerManager/transferToAnotherPlatform/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string52 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
