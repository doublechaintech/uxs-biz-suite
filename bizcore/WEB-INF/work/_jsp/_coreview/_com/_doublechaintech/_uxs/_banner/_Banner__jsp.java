...
public class _Banner__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      pageContext.requestSetOrRemove("ownerBeanName", "banner");
      out.write('\n');
      pageContext.requestSetOrRemove("ownerClassName", "Banner");
      ...
      pageContext.requestSetOrRemove("banner", _caucho_expr_8.evalObject(_jsp_env));
      out.write('\n');
      _jsp__include__tag_1 = new _jsp._tags._include__tag();
      _jsp__include__tag_1.setJspContext(pageContext);
      _jsp__include__tag_1.setPage("com/doublechaintech/uxs/banner/Banner$Summary.jsp");
      ...
      if (_caucho_expr_10.evalBoolean(_jsp_env)) {
        ...
        pageContext.requestSetOrRemove("targetList", _caucho_expr_11.evalObject(_jsp_env));
        out.write(_jsp_string15, 0, _jsp_string15.length);
        ...
        _jsp__include__tag_2.setReferName("banner");
    ...
    throws ServletException
  {
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ result.platform}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userContext.accessTokens[\"targetList\"] or ignoreListAccessControl}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.targetList}");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@home_page']}");
    _caucho_expr_13 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@message']}");
    _caucho_expr_14 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@log_out']}");
    _caucho_expr_15 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@qr_code']}");
    _caucho_expr_16 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@qr_scan_to_continue']}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/banner/Banner.jsp"), -4323638941913345844L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
