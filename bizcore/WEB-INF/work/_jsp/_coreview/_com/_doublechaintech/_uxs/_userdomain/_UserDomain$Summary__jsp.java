...
public class _UserDomain$Summary__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userDomain}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_domain']}");
    ...
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_domain.id']}");
    _caucho_expr_11 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${result.id}");
    _caucho_expr_12 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_domain.name']}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/userdomain/UserDomain$Summary.jsp"), -435953204073694375L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
