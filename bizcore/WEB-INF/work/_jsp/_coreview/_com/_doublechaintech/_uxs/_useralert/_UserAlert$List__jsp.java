...
package _jsp._coreview._com._doublechaintech._uxs._useralert;
...
public class _UserAlert$List__jsp extends com.caucho.jsp.JavaPage
{
 	...
 	//the reason using scriptlet here is the el express is currently not able resolv common property from a subclass of list
        ...
        while (_jsp_iter_7.hasNext()) {
          ...
          if (_caucho_expr_30.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatDateTag_1.setValue(_caucho_expr_45.evalObject(_jsp_env));
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty userAlertList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty userAlertList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'userAlertList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userAlertListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'message'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert.message']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'profile'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert.profile']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'location'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert.location']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'lastUpdate'}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert.last_update']}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'platform'}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['user_alert.platform']}");
    _caucho_expr_34 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_35 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userAlertList}");
    ...
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.message}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'$'}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.profile}");
    _caucho_expr_41 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.profile.id}");
    _caucho_expr_42 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.profile.displayName}");
    _caucho_expr_43 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.profile}");
    _caucho_expr_44 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.location}");
    _caucho_expr_45 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.lastUpdate}");
    _caucho_expr_46 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.platform}");
    _caucho_expr_47 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.id}");
    _caucho_expr_48 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.platform.displayName}");
    _caucho_expr_49 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.platform}");
    _caucho_expr_50 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@delete']}");
    _caucho_expr_51 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@copy']}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/useralert/UserAlert$List.jsp"), -9051342998524032607L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string55 = "/\"\n			data-switch-method=\"./userAlertManager/transferToAnotherPlatform/".toCharArray();
    ...
    _jsp_string43 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./userAlertManager/requestCandidateProfile/".toCharArray();
    _jsp_string14 = "\">".toCharArray();
    _jsp_string58 = "\n\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string26 = "</a>\n	</li>\n".toCharArray();
    _jsp_string63 = "/' class='copy-action btn btn-success btn-xs'><i class=\"fa fa-files-o fa-lg\"></i> ".toCharArray();
    _jsp_string4 = "Manager/addUserAlert/".toCharArray();
    _jsp_string62 = "Manager/copyUserAlertFrom/".toCharArray();
    _jsp_string49 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    ...
    _jsp_string6 = "\n\n\n\n\n	\n\n ".toCharArray();
    _jsp_string1 = "\n\n\n".toCharArray();
    _jsp_string52 = "	<td contenteditable='true' class='edit-value'  propertyToChange='location' storedCellValue='".toCharArray();
    _jsp_string33 = "\n				<tr currentVersion='".toCharArray();
    _jsp_string44 = "/\"\n			data-switch-method=\"./userAlertManager/transferToAnotherProfile/".toCharArray();
    _jsp_string30 = "</th>\n".toCharArray();
    _jsp_string8 = "\n    \n 	   \n    <div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		<i class='fa fa-table'></i> ".toCharArray();
    _jsp_string34 = "' id=\"userAlert-".toCharArray();
    ...
    _jsp_string16 = "\n	".toCharArray();
    _jsp_string9 = ")\n		<a href=\"./".toCharArray();
    _jsp_string54 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./userAlertManager/requestCandidatePlatform/".toCharArray();
    _jsp_string48 = "</a>\n			".toCharArray();
    _jsp_string3 = "! \n		 <a href=\"./".toCharArray();
    _jsp_string5 = "/\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\"></i></a>\n		 \n		 \n		 \n		 </div>\n	</div>\n\n".toCharArray();
    _jsp_string41 = "/'>".toCharArray();
    _jsp_string38 = "	<td contenteditable='true' class='edit-value'  propertyToChange='message' storedCellValue='".toCharArray();
    _jsp_string61 = "</a>\n				<a href='#".toCharArray();
    ...
    _jsp_string32 = "</th>\n		</tr></thead>\n		<tbody>\n			\n			".toCharArray();
    _jsp_string60 = "/' class='delete-action btn btn-danger btn-xs'><i class=\"fa fa-trash-o fa-lg\"></i> ".toCharArray();
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='userAlertListCurrentPage=".toCharArray();
    _jsp_string31 = "\n<th>".toCharArray();
    ...
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string53 = "	<td contenteditable='true' class='edit-value'  propertyToChange='lastUpdate' storedCellValue='".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./userAlertManager/view/".toCharArray();
    _jsp_string59 = "Manager/removeUserAlert/".toCharArray();
    _jsp_string40 = "Manager/updateUserAlert/".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string42 = "</td>\n".toCharArray();
    _jsp_string50 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
