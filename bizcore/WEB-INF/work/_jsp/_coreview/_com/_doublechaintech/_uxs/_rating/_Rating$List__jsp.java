...
package _jsp._coreview._com._doublechaintech._uxs._rating;
...
public class _Rating$List__jsp extends com.caucho.jsp.JavaPage
{
 	...
 	//the reason using scriptlet here is the el express is currently not able resolv common property from a subclass of list
        ...
        while (_jsp_iter_7.hasNext()) {
          ...
          if (_caucho_expr_30.evalBoolean(_jsp_env)) {
            ...
            _jsp_FormatDateTag_1.setValue(_caucho_expr_46.evalObject(_jsp_env));
    ...
    throws ServletException
  {
    ...
    _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ empty ratingList}");
    _caucho_expr_1 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@not_found']}");
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating']}");
    ...
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty ratingList}");
    ...
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${'ratingList' eq action.actionGroup}");
    ...
    _caucho_expr_18 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ratingListName}");
    ...
    _caucho_expr_23 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating.id']}");
    _caucho_expr_24 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'user'}");
    _caucho_expr_25 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating.user']}");
    _caucho_expr_26 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'product'}");
    _caucho_expr_27 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating.product']}");
    _caucho_expr_28 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'score'}");
    _caucho_expr_29 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating.score']}");
    _caucho_expr_30 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${param.referName ne 'updateTime'}");
    _caucho_expr_31 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['rating.update_time']}");
    _caucho_expr_32 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${userContext.localeMap['@action']}");
    _caucho_expr_33 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${ratingList}");
    ...
    _caucho_expr_37 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.user}");
    _caucho_expr_38 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.user.id}");
    _caucho_expr_39 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.user.displayName}");
    _caucho_expr_40 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.user}");
    _caucho_expr_41 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${not empty  item.product}");
    _caucho_expr_42 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.product.id}");
    _caucho_expr_43 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.product.displayName}");
    _caucho_expr_44 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${empty  item.product}");
    _caucho_expr_45 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.score}");
    _caucho_expr_46 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${item.updateTime}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("coreview/com/doublechaintech/uxs/rating/Rating$List.jsp"), -4771760634114018704L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string58 = "Manager/removeRating/".toCharArray();
    _jsp_string4 = "Manager/addRating/".toCharArray();
    _jsp_string50 = "/\"\n			data-link-template=\"./productManager/view/".toCharArray();
    _jsp_string41 = "{ID}/\">\n		<span class=\"display_span\">\n			".toCharArray();
    _jsp_string54 = "Manager/updateRating/".toCharArray();
    _jsp_string22 = "Manager/load".toCharArray();
    _jsp_string64 = "\n		\n		</tbody>\n	</table>	\n	\n\n</div>".toCharArray();
    _jsp_string51 = "\n			<a href='./productManager/view/".toCharArray();
    _jsp_string56 = "	<td contenteditable='true' class='edit-value'  propertyToChange='updateTime' storedCellValue='".toCharArray();
    _jsp_string39 = "/\"\n			data-switch-method=\"./ratingManager/transferToAnotherUser/".toCharArray();
    ...
    _jsp_string27 = "\n </ul>\n</nav>\n\n\n   \n\n\n	<table class=\"table table-striped\" pageToken='ratingListCurrentPage=".toCharArray();
    _jsp_string45 = "\n			".toCharArray();
    _jsp_string37 = "</a></td>\n".toCharArray();
    _jsp_string21 = "\">\n		<a href='#".toCharArray();
    ...
    _jsp_string11 = "\n		".toCharArray();
    _jsp_string35 = "\" ><td><a class=\"link-action-removed\" href=\"./ratingManager/view/".toCharArray();
    _jsp_string36 = "/\"> ".toCharArray();
    _jsp_string6 = "\n\n\n\n\n	\n\n ".toCharArray();
    _jsp_string1 = "\n\n\n".toCharArray();
    _jsp_string33 = "\n				<tr currentVersion='".toCharArray();
    _jsp_string61 = "Manager/copyRatingFrom/".toCharArray();
    _jsp_string30 = "</th>\n".toCharArray();
    _jsp_string8 = "\n    \n 	   \n    <div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		<i class='fa fa-table'></i> ".toCharArray();
    _jsp_string47 = "\n			<button class=\"btn btn-link candidate-action\">...</button>\n		</span>\n		<div class=\"candidate_span\" style=\"display:none;\">\n			<input type=\"text\" data-provide=\"typeahead\" class=\"input-sm form-control candidate-filter-input\" autocomplete=\"off\" />\n		</div>\n	</td>\n".toCharArray();
    _jsp_string2 = "\n	<div class=\"row\" style=\"font-size: 30px;\">\n		<div class=\"col-xs-12 col-md-12\" style=\"padding-left:20px\">\n		 ".toCharArray();
    _jsp_string17 = "\n	</div><!--end of div class=\"btn-group\" -->\n	\n		 \n		 \n		 \n		 </div>\n </div>\n    \n    \n<div class=\"table-responsive\">\n\n\n".toCharArray();
    _jsp_string49 = "/\"\n			data-switch-method=\"./ratingManager/transferToAnotherProduct/".toCharArray();
    _jsp_string28 = "'>\n		<thead><tr>\n		".toCharArray();
    _jsp_string63 = " </a>\n\n				</td>\n				</tr>\n			".toCharArray();
    _jsp_string57 = "\n				<td>\n\n				<a href='#".toCharArray();
    _jsp_string38 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./ratingManager/requestCandidateUser/".toCharArray();
    _jsp_string16 = "\n	".toCharArray();
    _jsp_string9 = ")\n		<a href=\"./".toCharArray();
    _jsp_string44 = "</a>\n			".toCharArray();
    _jsp_string3 = "! \n		 <a href=\"./".toCharArray();
    ...
    _jsp_string53 = "' prefix='".toCharArray();
    _jsp_string52 = "	<td contenteditable='true' class='edit-value'  propertyToChange='score' storedCellValue='".toCharArray();
    _jsp_string24 = "RowsPerPage=".toCharArray();
    _jsp_string48 = "\n	<td class=\"select_candidate_td\"\n			data-candidate-method=\"./ratingManager/requestCandidateProduct/".toCharArray();
    _jsp_string32 = "</th>\n		</tr></thead>\n		<tbody>\n			\n			".toCharArray();
    ...
    _jsp_string7 = "\n    \n    \n".toCharArray();
    _jsp_string34 = "' id=\"rating-".toCharArray();
    _jsp_string19 = " \n".toCharArray();
    _jsp_string55 = "</td>\n".toCharArray();
    _jsp_string46 = "\n			<a href='#'></a>\n			".toCharArray();
    _jsp_string15 = "</a>\n		".toCharArray();
