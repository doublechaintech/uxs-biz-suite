<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.useralert.UserAlert'%>
...
<c:set var="ownerBeanName" value="userAlert" scope="request"/>
<c:set var="ownerClassName" value="UserAlert" scope="request"/>
...
<div class="row">
	...
	<% UserAlert result = (UserAlert)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userAlert" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/useralert/UserAlert$Summary.jsp" />
