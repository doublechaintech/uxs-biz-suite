<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.catalog.Catalog'%>
...
<sky:include page="com/doublechaintech/uxs/catalog/Catalog$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/site/Site$Info.jsp" />
...
<sky:include page="com/doublechaintech/uxs/platform/Platform$Info.jsp" />
		...
		<div id="levelOneCategoryList" class="tab-pane fade sublist" refer-name="catalog">
			<sky:include page="com/doublechaintech/uxs/levelonecategory/LevelOneCategory$List.jsp"
					referName="catalog"/>
		</div>
	</c:if>
	...
	<c:if test='${not empty userContext.accessTokens["newProductList"] or ignoreListAccessControl}'>
		...
		<div id="newProductList" class="tab-pane fade sublist" refer-name="catalog">
	...
	<c:if test='${not empty userContext.accessTokens["editorPickProductList"] or ignoreListAccessControl}'>
		...
		<div id="editorPickProductList" class="tab-pane fade sublist" refer-name="catalog">
	...
	<c:if test='${not empty userContext.accessTokens["topRatedProductList"] or ignoreListAccessControl}'>
		...
		<div id="topRatedProductList" class="tab-pane fade sublist" refer-name="catalog">
	...
	<c:if test='${not empty userContext.accessTokens["recommandProductList"] or ignoreListAccessControl}'>
		...
		<div id="recommandProductList" class="tab-pane fade sublist" refer-name="catalog">
