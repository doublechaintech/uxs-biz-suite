<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/uxs/listaccess/ListAccess$Summary.jsp" />
