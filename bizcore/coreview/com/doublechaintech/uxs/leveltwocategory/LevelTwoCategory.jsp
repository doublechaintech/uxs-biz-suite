<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.leveltwocategory.LevelTwoCategory'%>
...
<sky:include page="com/doublechaintech/uxs/leveltwocategory/LevelTwoCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/levelonecategory/LevelOneCategory$Info.jsp" />
		...
		<div id="levelNCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/uxs/levelncategory/LevelNCategory$List.jsp"
