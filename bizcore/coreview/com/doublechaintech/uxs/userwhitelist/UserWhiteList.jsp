<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/uxs/userwhitelist/UserWhiteList$Summary.jsp" />
