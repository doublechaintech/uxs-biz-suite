<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.product.Product'%>
...
<sky:include page="com/doublechaintech/uxs/product/Product$Summary.jsp" />
