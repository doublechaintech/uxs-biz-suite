<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/uxs/loginhistory/LoginHistory$Summary.jsp" />
