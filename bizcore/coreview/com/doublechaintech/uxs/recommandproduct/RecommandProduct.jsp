<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.recommandproduct.RecommandProduct'%>
...
<c:set var="ownerBeanName" value="recommandProduct" scope="request"/>
<c:set var="ownerClassName" value="RecommandProduct" scope="request"/>
...
<div class="row">
	...
	<% RecommandProduct result = (RecommandProduct)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="recommandProduct" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/recommandproduct/RecommandProduct$Summary.jsp" />
