<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.categoryfilter.CategoryFilter'%>
...
<c:set var="ownerBeanName" value="categoryFilter" scope="request"/>
<c:set var="ownerClassName" value="CategoryFilter" scope="request"/>
...
<div class="row">
	...
	<% CategoryFilter result = (CategoryFilter)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="categoryFilter" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/categoryfilter/CategoryFilter$Summary.jsp" />
