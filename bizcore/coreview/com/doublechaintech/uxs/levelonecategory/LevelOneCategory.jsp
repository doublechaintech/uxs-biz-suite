<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.levelonecategory.LevelOneCategory'%>
...
<sky:include page="com/doublechaintech/uxs/levelonecategory/LevelOneCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/catalog/Catalog$Info.jsp" />
		...
		<div id="levelTwoCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/uxs/leveltwocategory/LevelTwoCategory$List.jsp"
