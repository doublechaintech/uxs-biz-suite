<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.userdomain.UserDomain'%>
...
<sky:include page="com/doublechaintech/uxs/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/uxs/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/uxs/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
