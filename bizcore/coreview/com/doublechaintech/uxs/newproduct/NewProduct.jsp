<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.newproduct.NewProduct'%>
...
<c:set var="ownerBeanName" value="newProduct" scope="request"/>
<c:set var="ownerClassName" value="NewProduct" scope="request"/>
...
<div class="row">
	...
	<% NewProduct result = (NewProduct)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="newProduct" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/newproduct/NewProduct$Summary.jsp" />
