<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.target.Target'%>
...
<c:set var="ownerBeanName" value="target" scope="request"/>
<c:set var="ownerClassName" value="Target" scope="request"/>
...
<div class="row">
	...
	<% Target result = (Target)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="target" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/target/Target$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/banner/Banner$Info.jsp" />
