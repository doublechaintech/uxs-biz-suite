<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.pricefilter.PriceFilter'%>
...
<c:set var="ownerBeanName" value="priceFilter" scope="request"/>
<c:set var="ownerClassName" value="PriceFilter" scope="request"/>
...
<div class="row">
	...
	<% PriceFilter result = (PriceFilter)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="priceFilter" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/pricefilter/PriceFilter$Summary.jsp" />
