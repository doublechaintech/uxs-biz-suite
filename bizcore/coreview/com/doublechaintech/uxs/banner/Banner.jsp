<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.banner.Banner'%>
...
<c:set var="ownerBeanName" value="banner" scope="request"/>
<c:set var="ownerClassName" value="Banner" scope="request"/>
...
<div class="row">
	...
	<% Banner result = (Banner)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="banner" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/banner/Banner$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/platform/Platform$Info.jsp" />
		...
		<div id="targetList" class="tab-pane fade sublist" refer-name="banner">
			<sky:include page="com/doublechaintech/uxs/target/Target$List.jsp"
					referName="banner"/>
		</div>
	</c:if>
