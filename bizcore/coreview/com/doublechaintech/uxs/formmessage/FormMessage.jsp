<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/uxs/formmessage/FormMessage$Summary.jsp" />
