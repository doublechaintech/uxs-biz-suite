<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/uxs/secuserblocking/SecUserBlocking$Summary.jsp" />
