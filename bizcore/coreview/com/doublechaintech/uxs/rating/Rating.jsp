<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.rating.Rating'%>
...
<sky:include page="com/doublechaintech/uxs/rating/Rating$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/product/Product$Info.jsp" />
