<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.platform.Platform'%>
...
<sky:include page="com/doublechaintech/uxs/platform/Platform$Summary.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["bannerList"] or ignoreListAccessControl}'>
		...
		<div id="bannerList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/uxs/banner/Banner$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
