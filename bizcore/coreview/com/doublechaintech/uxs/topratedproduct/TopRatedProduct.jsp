<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.topratedproduct.TopRatedProduct'%>
...
<c:set var="ownerBeanName" value="topRatedProduct" scope="request"/>
<c:set var="ownerClassName" value="TopRatedProduct" scope="request"/>
...
<div class="row">
	...
	<% TopRatedProduct result = (TopRatedProduct)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="topRatedProduct" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/topratedproduct/TopRatedProduct$Summary.jsp" />
