<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.editorpickproduct.EditorPickProduct'%>
...
<c:set var="ownerBeanName" value="editorPickProduct" scope="request"/>
<c:set var="ownerClassName" value="EditorPickProduct" scope="request"/>
...
<div class="row">
	...
	<% EditorPickProduct result = (EditorPickProduct)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="editorPickProduct" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/editorpickproduct/EditorPickProduct$Summary.jsp" />
...
<sky:include page="com/doublechaintech/uxs/profile/Profile$Info.jsp" />
