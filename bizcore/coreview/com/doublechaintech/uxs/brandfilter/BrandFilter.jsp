<%@ page import='java.util.*,com.doublechaintech.uxs.*,com.doublechaintech.uxs.brandfilter.BrandFilter'%>
...
<c:set var="ownerBeanName" value="brandFilter" scope="request"/>
<c:set var="ownerClassName" value="BrandFilter" scope="request"/>
...
<div class="row">
	...
	<% BrandFilter result = (BrandFilter)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="brandFilter" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/uxs/brandfilter/BrandFilter$Summary.jsp" />
